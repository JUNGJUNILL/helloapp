        ...
        return (
          <div>
            ...
            <div style={{width:'100%',textAlign:"center",marginTop:'5%'}}>
                <font style={{fontFamily:'Roboto-BlackItalic',fontSize:'4vh'}}>The price of before increase(decrease) price.</font>
            </div>
            
            <div className='imgDiv' style={{marginTop:'5%'}}>
                <div className='imgTextCenter' style={{fontFamily:'Roboto-BlackItalic',fontSize:'3vh'}}>The  price of Bacon before {check==='up'?'increase':'decrease'} price.</div>
            ...
            <div style={{width:'100%',textAlign:"center",marginTop:'3%'}}>
                <font style={{fontFamily:'Roboto-BlackItalic',fontSize:'5vh'}} >${result.toFixed(1)}</font>        
            </div>

            <div style={{width:'100%',textAlign:"center",marginTop:'3%'}}>
                <font style={{fontFamily:'Roboto-Medium',fontSize:'3vh'}}>
                Bacon was <Select defaultValue={check} size='large' onChange={onChangeCondition}>
         ...
         &nbsp; percent to&nbsp;$<Input  
                        ...
                        />
                <br />
                 How much is the price before the {check==='up'?'increase':'decrease'}?
